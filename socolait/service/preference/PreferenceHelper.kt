package mg.socolait.service.preference
...
object PreferenceHelper {
    ...
    private const val PREFS_NAME = "socolait_prefs"

    fun defaultPrefs(context: Context): SharedPreferences =
            PreferenceManager.getDefaultSharedPreferences(context)

    fun customPrefs(context: Context, name: String? = PREFS_NAME): SharedPreferences =
